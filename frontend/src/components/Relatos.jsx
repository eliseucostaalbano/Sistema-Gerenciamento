...
import { BadgeCheck, CalendarDays, MessagesSquareIcon, VerifiedIcon } from "lucide-react";
    ...
    <section className={testimonialStyles.section}>
      <div className={testimonialStyles.container}>
        ...
        <p className={testimonialStyles.subtitle}>
          Descobra com nossos estudantes que transformaram suas carreiras com
          projetos hands-on e mentoria expert
        </p>
      </div>
      ...
      <div className={testimonialStyles.grid}>
        {testimonials.map((t, i) => (
          <div
            onMouseMove={(e) => onMouseMove(e, cartasRef.current[i], i)}
            onMouseLeave={() => onMouseLeave(cartasRef.current[i])}
            key={t.id}
          ...
          >
            ...
            >
              ...
              <div className={testimonialStyles.quoteIcon}>
                <MessagesSquareIcon className={testimonialStyles.quoteIconSvg} />
              </div>
                ...
                <div className={testimonialStyles.userInfo}>
                  <div className={testimonialStyles.userHeader}>
                    <div className="min-w-0">
                      <h3 className={testimonialStyles.userName}>{t.nome}</h3>
